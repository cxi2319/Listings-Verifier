"""
Module to tokenize Yext and publisher Name field data, extract token-level probabilities and calculate the transition probabilities of Yext Name data to publisher Name data. Returns a TSV file containing all raw Yext and publisher strings, tokenized strings, edits, and edit probability.
...
SCHEMA = "PUBLIC"
TABLE = "HISTORICAL_NAME_TRANSITION_PROBA"
...
def get_deletions_dict() -> dict:
    ...
    query = """
                SELECT 
                    ...
                    TOKEN_PROBABILITY
                FROM 
                    PROD_DATA_SCIENCE.PUBLIC.NAMES_TOKEN_DELETE_PROBA
                ORDER BY 
                    2 DESC
    """
...
def get_insertions_dict() -> dict:
    ...
    query = """
                SELECT 
                    ...
                    TOKEN_PROBABILITY 
                FROM 
                    PROD_DATA_SCIENCE.PUBLIC.NAMES_TOKEN_INSERT_PROBA         
                ORDER BY 
                    2 DESC
    """
...
def get_swaps_dict() -> dict:
    ...
    query = """
                SELECT
                    ...
                    TOKEN_PROBABILITY
                FROM
                    PROD_DATA_SCIENCE.PUBLIC.NAMES_TOKEN_TRANSFORM_PROBA
                ORDER BY 
                    2 DESC
    """
...
def get_all_yext_prob_df() -> pd.DataFrame:
    ...
    query = """
                SELECT 
                    ...
                    TOKEN_PROBABILITY 
                FROM 
                    PROD_DATA_SCIENCE.PUBLIC.ALL_YEXT_NAME_TOKEN_PROBA 
                ORDER BY 
                    3 DESC
    """
...
def get_all_pub_prob_df() -> pd.DataFrame:
    ...
    query = """
                ...
                FROM
                    PROD_DATA_SCIENCE.PUBLIC.ALL_PUB_NAME_TOKEN_PROBA
                ORDER BY 
                    3 DESC
    """
...
def process_final_df(
    ...
    if snowflake:
        ...
        filtered_df_csv = filtered_df.to_csv(
            r"/Users/cxi/datascience/listings_verifier/dataframe_outputs/name_token_transform_proba.tsv",
            sep="\t",
            index=False,
            header=False,
        )
